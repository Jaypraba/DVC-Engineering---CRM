...
export function ImageStreamHero({
  ...
  const css = React.useMemo(
    () =>
      ...
      //
      // `!important` is load-bearing, not defensive. Each card sets the
      // `animation` *shorthand* inline, and that shorthand resets
      // `animation-play-state` to `running`. An inline declaration outranks a
      // stylesheet rule, so without `!important` this pause never applies and
      // the corridor keeps moving for people who asked it not to.
